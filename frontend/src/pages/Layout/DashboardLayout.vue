    ...
    <div class="wrapper" :class="{'nav-open': $sidebar.showSidebar}">
        ...
        <side-bar title="NATCA Portal">
            <template slot-scope="props" slot="links">
                ...
                <sidebar-item
                        :link="{name: 'Dashboard', icon: 'fas fa-tachometer-alt', path: '/dashboard'}">
                </sidebar-item>
                <sidebar-item
                ...
                <sidebar-item
                        :link="{name: 'Resources', icon: 'fas fa-book-reader', path: '/table-list/regular'}"></sidebar-item>
                <sidebar-item
                        :link="{name: 'Academy', icon: 'fas fa-graduation-cap', path: '/table-list/regular'}"></sidebar-item>
                <sidebar-item
                        :link="{name: 'Registrations', icon: 'far fa-calendar-alt', path: '/table-list/regular'}"></sidebar-item>
            </template>
        </side-bar>
